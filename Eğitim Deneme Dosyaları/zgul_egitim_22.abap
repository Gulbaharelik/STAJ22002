...
FORM save_data .
    gs_log-ad = gv_ad.
        ...
        ELSE.
          gs_log-cinsiyet ='E'.
        ENDIF.
        INSERT zgul_egt_04 FROM gs_log.
...
*****     IF gv_rad1 eq 'X'.
****     IF gv_rad1 eq abap_true.
****       MESSAGE 'Cinciyeti kadın olarak seçildi.' TYPE 'I'.
****     ELSE.
****     MESSAGE 'Cinciyeti erkek olarak seçildi.' TYPE 'I'.
****     ENDIF.
