*İlk aşama internal table salv ye bağla
*İkinci aşama salv yi ekrana bas
*
*REPORT zgul_egitim_19.
*
...
*Yapıları kontrol altına almak için kolon okuma kısımları try-catch içinde yazılır.
  TRY.
...
*ALV'lerin kontrolleri için kullanılan butonların görüntülenmesi.
  DATA: lo_func TYPE REF TO cl_salv_functions.
  lo_func = go_salv->get_functions( ).
  lo_func->set_all(
      value = if_salv_c_bool_sap=>true ).

* Üst alan ve üst başlık eklemek için kullanılır.
...
*ALV popup şeklinde gösterilmek istenirse kullanılır.
